...
from .models import IMPORTANCE, Answer, Question

class UsersAnsform(forms.Form):
    question_id = forms.IntegerField()
    answer_id = forms.IntegerField()
    roommie_ans_id = forms.IntegerField()

    class UserResponseForm(forms.Form):
        question_id = forms.IntegerField()
        answer_id = forms.IntegerField()
        importance_level = forms.ChoiceField(choices=IMPORTANCE)
        their_answer_id = forms.IntegerField()
        their_importance_level = forms.ChoiceField(choices=IMPORTANCE)
        ...
        # if this object exist, try otherwise print error
